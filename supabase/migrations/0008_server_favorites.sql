...
--
-- ⓘ **번호가 0006 → 0008 로 바뀌었다** (2026-08-11). 같은 날 다른 브랜치에서 0006·0007
--   (discord 링크 자동 수집)이 먼저 라이브에 적용돼 번호가 겹쳤다. 파일 이름만 바꿨을 뿐
--   내용은 그대로이고, **라이브에는 이미 적용돼 있다** — 다시 실행할 필요 없다(재실행해도 안전).
--
-- ## 왜 옮기나
